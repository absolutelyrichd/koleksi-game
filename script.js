...
let gameModal, modalContent, gameForm, cancelButton, modalTitle, gameRowsContainer, addRowButton;
let bulkEditModal, bulkEditModalContent, bulkEditForm, bulkEditCancelButton, bulkEditInfo;
let deleteConfirmModal, deleteConfirmModalContent, deleteConfirmMessage, cancelDeleteButton, confirmDeleteButton;
let sidebar, openSidebarButton, closeSidebarButton, mobileMenuBackdrop;
let platformChart, locationChart, statusChart;
let selectAllCheckbox, bulkDeleteButton, bulkEditButton, selectionInfo;
let filterTitle, filterPlatform, filterLocation, filterStatus;


// --- LOGIKA UTAMA DI DALAM DOMContentLoaded ---
document.addEventListener('DOMContentLoaded', () => {
    ...
    gameListBody = document.getElementById('game-list-body');
    gameListCards = document.getElementById('game-list-cards');
    gameListCardsEmpty = document.getElementById('game-list-cards-empty');
    addGameButton = document.getElementById('add-game-button');
    paginationContainer = document.getElementById('pagination-container');

    totalPriceElement = document.getElementById('total-price');
    mostExpensiveGameElement = document.getElementById('most-expensive-game');
    ...
    gameRowsContainer = document.getElementById('game-rows-container');
    addRowButton = document.getElementById('add-row-button');

    bulkEditModal = document.getElementById('bulk-edit-modal');
    bulkEditModalContent = document.getElementById('bulk-edit-modal-content');
    bulkEditForm = document.getElementById('bulk-edit-form');
    bulkEditCancelButton = document.getElementById('bulk-edit-cancel-button');
    bulkEditInfo = document.getElementById('bulk-edit-info');
    ...
    bulkEditButton = document.getElementById('bulk-edit-button');
